...
Selector labels
*/}}
{{- define "java-backend.selectorLabels" -}}
app.kubernetes.io/name: {{ include "java-backend.name" . }}
...
{{- default (include "java-backend.fullname" .) .Values.serviceAccount.name }}
{{- else }}
